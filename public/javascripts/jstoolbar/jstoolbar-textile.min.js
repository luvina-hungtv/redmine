...
,jsToolBar.prototype.elements.tmp_addTicket={type:'button',title:'Template add Ticket',fn:{wiki:function(){ this.encloseLineSelection('*1. Subject ticket (JP)*\n', '\n*2. Nội dung (JP)*\n\n-------------------------\n\n*3. Nội dung (VN)*\n')}}}
,jsToolBar.prototype.elements.tmp_addQA={type:'button',title:'Template add Q&A',fn:{wiki:function(){ this.encloseLineSelection('*1. Require*\n+ Thiết Kế: ', '(TKCT hay TKCB)\n+ ID màn hình:\n+ Sheet:\n+ Hạng mục:\n+ Action:\n\n*2. Vấn đề gặp phải*\nVới require hiện tại thì đang gặp vấn đề gì?\n\n*3. Vấn đề xác nhận*\nVới vấn đề gặp phải như vậy, cần xác nhận điều gì?\n\n*4. Phương án đề xuất*\n(Option)')}}}
...
,jsToolBar.prototype.elements.tmp_addBugReview={type:'button',title:'Template add bug review',fn:{wiki:function(){ this.encloseLineSelection('*1. Vị trí*\n+ File: ', '\n+ Version:\n+ Method/Line/ID case:\n\n*2. Hiện trạng*\n\n*3. Mong muốn*')}}}
,jsToolBar.prototype.elements.tmp_ReFixbug={type:'button',title:'Template fix bug',fn:{wiki:function(){ this.encloseLineSelection('h1. Kết quả xử lý bug\n\n*1. Flow tái hiện bug:*\n', '\n*2. Nguyên nhân:*\n\n*3. Chức năng ảnh hưởng:*\n\n*4. D/s file sửa:*\n\n*5. Revision:*')}}}
,jsToolBar.prototype.elements.tmp_ReIgnore={type:'button',title:'Template Ignore bug',fn:{wiki:function(){ this.encloseLineSelection('h1. Kết quả xác nhận ignore (Leader)!\n\n*1. Nguyên nhân ignore*\n', '\n*2. Kết luận (Đồng ý/Không đồng ý/Đăng ký bug mới)*')}}}
,jsToolBar.prototype.elements.tmp_ReConfirm={type:'button',title:'Template confirm bug/Q&A',fn:{wiki:function(){ this.encloseLineSelection('h1. Kết quả confirm bug nội bộ (bug test, bug review) hoặc Q&A\n\n*1. Revision: ', '*\n*2. Trạng thái: (OK/NG)*\n(NG: Confirm xong và có bug/vấn đề phát sinh)')}}}
,jsToolBar.prototype.elements.tmp_ReFixTicket={type:'button',title:'Template fix bug KH',fn:{wiki:function(){ this.encloseLineSelection('h1. Kết quả xử lý bug khách hàng\n\n*1. Nguyên nhân (Trực tiếp - Gián tiếp)*\n', '\n*2. Phạm vi chỉnh sửa & ảnh hưởng*\n\n*3. Phương pháp chỉnh sửa*\n\n*4. D/s file sửa*\n\n*5. Version commit source code*')}}}
,jsToolBar.prototype.elements.tmp_ReDieuTra={type:'button',title:'Template báo cáo điều tra',fn:{wiki:function(){ this.encloseLineSelection('h1. Kết quả điều tra\n\n*1. Flow tái hiện bug*\n', '\n*2. Nguyên nhân (Trực tiếp - Gián tiếp)*\n\n*3. Phạm vi chỉnh sửa & ảnh hưởng*\n\n*4. Phương pháp chỉnh sửa*\n\n*5. Công số estimate (MH)*\n+ Code:\n+ Test:')}}}
,jsToolBar.prototype.elements.tmp_PhantichBug={type:'button',title:'Template phân tích bug UAT',fn:{wiki:function(){ this.encloseLineSelection('h1. Kết quả phân tích bug khách hàng\n\n*1. Nguyên nhân trực tiếp*\n', '\n*2. Biện pháp giải quyết*\n\n*3. Nguyên nhân gốc rễ*\n\n*4. Biện pháp phòng ngừa*')}}}
